          ...
          {ownProjects.map((project, index) => (
            <Reveal key={project.name} delay={index * 0.08}>
              <a
                ...
                className="glass-panel group flex h-full flex-col rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[color:var(--color-accent)]/50"
              >
